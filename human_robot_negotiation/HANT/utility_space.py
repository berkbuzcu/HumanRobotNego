...
import itertools
import math
import human_robot_negotiation.HANT.nego_action as nego_action
...
class UtilitySpace:
    ...
    def __generate_all_possible_offers(self):
        ...
        """
        self.all_possible_offers = [dict(zip(self.issue_names, item)) for item in itertools.product(*self.issue_values_list.values())]
