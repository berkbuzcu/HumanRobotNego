import sys
import copy
from PySide6.QtCore import QSize, Qt, QTimer, SIGNAL, QTime, QMargins, QAbstractTableModel, Signal, QObject
...
if __name__ == "__main__":
    ...
    gui = NegotiationGUI(app.screens()[-1], NegotiationTimer(deadline=6000, timeout_callback=lambda x: print("aaaa")), "Anıl")
    gui.show()
    app.exec()
