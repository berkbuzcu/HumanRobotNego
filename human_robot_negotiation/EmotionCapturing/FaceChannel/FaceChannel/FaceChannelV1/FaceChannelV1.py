...
from human_robot_negotiation.EmotionCapturing.FaceChannel.FaceChannel.Metrics import metrics
from human_robot_negotiation.EmotionCapturing.FaceChannel.FaceChannel.FaceChannelV1 import imageProcessingUtil
...
class FaceChannelV1:
    ...
    def __init__(self, type="Cat", loadModel=True, numberClasses=7):
        ...
        self.dense_model = Model(inputs=self.model.inputs, outputs=[denseLayerOutput])
