from human_robot_negotiation.core.nego_action import Offer, Accept
from human_robot_negotiation.core.sensitivity_calculator import SensitivityCalculator
import typing as t
...
class NegotiationHistory:
    ...
    def get_agent_move_list(self) -> t.List[str]:
        ...
        if len(agent_history) > 0:
            ...
            agent_moves = get_target_move_list(
    ...
    def get_human_move_list(self) -> t.List[str]:
        ...
        human_moves = get_target_move_list(
    ...
    def extract_history_to_df(self):
        ...
        self.human_sensitivity_rates = get_sensitivity_rate(
            human_moves
        )
    ...
    def get_human_sensitivity_rates(self):
        return get_sensitivity_rate(self.get_human_move_list())
