...
class AbstractSession(ABC):
    ...
    def __init__(self, participant_name: str, session_id: str, session_type: str):
        ...
        with graph.as_default():
            ...
            self.training_manager = TrainManager(sess, graph, experiment_gwrs, self.face_channel)
    ...
    def predict_cl(self, log_dir: str, update_min_max: bool = True) -> list:
        ...
        if len(self.training_manager.models) > 0:
            ...
            predictions = predict(log_dir=log_dir, model=model_copy, sess=sess, graph=graph, face_channel=self.face_channel)
